...
class Bishop(Figure):
    ...
    def _get_moves_top_right(self, position: tuple[int, int], chessboard: "Chessboard") -> list[tuple[int, int]] | None:
        x, y = position
        if x + 1 < 8 and y + 1 < 8:
    ...
    def _get_moves_bottom_right(self, position: tuple[int, int], chessboard: "Chessboard") -> list[tuple[
        int, int]] | None:
        x, y = position
    ...
    def _get_moves_bottom_left(self, position: tuple[int, int], chessboard: "Chessboard") -> list[tuple[int, int]] | None:
        x, y = position
    ...
    def _get_moves_top_left(self, position: tuple[int, int], chessboard: "Chessboard") -> list[tuple[int, int]] | None:
        x, y = position
