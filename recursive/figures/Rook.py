...
class Rook(Figure):
    ...
    def _get_moves_top(self, position: tuple[int, int], chessboard: "Chessboard") -> list[tuple[int, int]] | None:
        x, y = position
        if x + 1 < 8:
    ...
    def _get_moves_bottom(self, position: tuple[int, int], chessboard: "Chessboard") -> list[tuple[int, int]] | None:
        x, y = position
    ...
    def _get_moves_left(self, position: tuple[int, int], chessboard: "Chessboard") -> list[tuple[int, int]] | None:
        x, y = position
    ...
    def _get_moves_right(self, position: tuple[int, int], chessboard: "Chessboard") -> list[tuple[int, int]] | None:
        x, y = position
